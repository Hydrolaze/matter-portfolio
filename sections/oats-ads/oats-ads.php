...
?>
    <h2>My first large-format public advertisement</h2>
    </header>
    <div class="copy">
       <?php single_photo($section_name, false, 'ad-in-situ.jpg', 200, 'right', 'I was elated to see my work on public display in the mall.'); ?>
       
        <p>While I worked as a designer at Mouse Graphics, a respresentative from a local optometry practice reached out to have their branding redone and an ad created. This was very exciting, as the ad would be mounted in a backlit directory display, and would therefore be viewed by the thousands of people that frequent The Shops at Mission Viejo. I was provided with their existing logo and a rough mockup of the ad design they wanted. My first task was to update the logo, adding eyelids and eyelashes to frame the eye into a more recognizable form.</p>
        
        <?php single_photo($section_name, false, 'oats-ad-client-mockup.jpg', 240, 'left', 'The initial mockup that the client provided, which informed my stylistic choices.'); ?>
        ...
        <p>One reason for the creation of the new logo was that it would be used in an updated website that the firm was having created. While working on the logo however, I realized that viewing lines in the iris at the lower resolutions and sizes that would be necessary on the web caused a moiré pattern. To rectify this, I created a simplified version of the logo using half the lines at double the thickness. I packaged both logo versions in both vector and raster formats into a ZIP file for their web designer to use.</p>

        <?php photogrid($section_name, 'logo-versions', 3, 3, 'center'); ?>

        <p>Once the final logo was selected, I began work on the ad. Going off of the assumption that the mockup reflected their design preferences, I chose dominant colors of cyan and smoky, translucent black, with crysanthemum yellow as an accent.</p>
        ...
        <?php single_photo($section_name, false, 'oats-ad-proof-v2.png', 320, 'right', 'With the alternate photo of Dr. Ciobanu, my second draft was much more balanced and appealing.'); ?>
        ...
        <?php single_photo($section_name, false, 'oats-holiday-ad.jpg', 320, 'left', 'I saved time designing this by reusing snowflakes that I had created for another design project.'); ?>
