...
?>
    ...
    <div class="copy">
        ...
        <?php single_photo($section_name, false, 'oats-ad-client-mockup.jpg', 240, 'right', 'The initial mockup that the client provided, which informed my stylistic choices.'); ?>

        <span class="caption">The client wanted the logo to change only slightly, so as to preserve the brand association they had built over the years.</span>
