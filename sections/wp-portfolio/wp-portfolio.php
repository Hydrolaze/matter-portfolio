...
?>
    ...
    <?php single_photo($section_name, 'http://clement.matmcc.org/portfolio/','wp-portfolio-screenshot.png', 720, 'centre', 'Wordpess let me manage posts and content easily, and plugins gave me easy interactivity.'); ?>
    ...
    <?php single_photo($section_name, 'https://wordpress.com/themes/blask/', 'blask-theme.jpg', 360, 'right', 'Blask by Automattic.'); ?>
    ...
    <?php single_photo($section_name, false, 'limb-gallery-screenshot.png', 360, 'left', 'Limb Gallery, a versatile plugin I used to create galleries.'); ?>
