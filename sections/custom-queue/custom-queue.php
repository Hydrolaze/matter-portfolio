...
<section id="custom-queue">
    ...
    <p>I hand-selected the pieces below for you at <span style="font-weight:900;"><?php echo $company['name']; ?></span> to demonstrate my qualification for the position of <span style="font-weight:900;"><?php echo $company['position']; ?></span>. You may use the panel to the left to navigate the queue. Enjoy!</p>
