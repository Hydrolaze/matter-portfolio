...
?>
    ...
    <div class="copy">
        ...
        <?php photogrid($section_name, 'recreations', 3, 4, 'center'); ?>
        ...
        <?php single_photo($section_name, false, 'dampfheizung.png', 320, 'left', 'I was very glad to use German, which I hadn\'t done since school.') ?>
