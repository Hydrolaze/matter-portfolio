...
?>
    ...
    <div class="copy">
        ...
        <?php single_photo($section_name, 'works/roryquest/index.html', 'roryquest-screenshot.png', 720, 'centre', 'There\'s no goal to the game as it exists now, but it was a fun exploration into sprite animation and game physics.'); ?>
        ...
        <p>I also defined some states that would change the way the spritesheet rendered. For example, when motionless the spritesheet would render a static sitting frame, but when jumping, the spritesheet would render a frame from a jumping animation that corresponded visually to the cat’s movement vector.</p>
    </div>
    </section>
