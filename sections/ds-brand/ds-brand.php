...
?>
    ...
    <?php single_photo($section_name, 'old-DS.png', 360, 'left'); ?>
    ...
    <?php single_photo($section_name, 'DS-swatches.png', 360, 'left'); ?>
    ...
    <?php single_photo($section_name, 'DS-bizcard.png', 720, 'centre'); ?>
    
    <span class="caption">Business cards I created for the sales representatives at the company.</span>

    <?php single_photo($section_name, 'DS-ad.png', 720, 'centre'); ?>
