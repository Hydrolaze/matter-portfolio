...
?>
   ...
   <?php single_photo($section_name, false, 'Kohana-flier-proof-v1.jpg', 280, 'right', 'The product photo layout is rough because I wasn\'t sure yet if the client would like the rest of the layout.'); ?>
    ...
    <?php single_photo($section_name, false, 'Kohana-flier-print.jpg', 280, 'left', 'The final design, with bleed area and cropmarks.'); ?>
