...
<body>
    ...
    <main>
        <section id="hello" class="intro-section">
            ...
            <div class="copy">
                <p>I'm a graphic designer who is currently looking for challenging and rewarding work in North San Diego county. I have been working in print design for 5 years <!-- I began working at Logo Expressions in June 2013, exactly five years before now. -->, and in that time I've learned to design for a wide range of printing methods.  I have have considerable experience in web graphics and programming as well. </p>
                
                
                <?php if ($key_is_valid): ?>
                
                <p>I designed this portfolio was designed to serve up a custom experience to visitors with a unique url key. Your key unlocks an exclusive queue of portfolio pieces that I'd love you to see.</p>
                ...
                <div class="queue-container">
                    ...
                    <span class="icon-desc">
                        <h4>CUSTOM QUEUE</h4>
                        A collection of works picked specially for you at <?php echo $company['name']; ?> to show my qualification for the position of <?php echo $company['position']; ?>.
                    </span>
                </div>
